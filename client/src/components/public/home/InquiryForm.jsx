      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            >
              <option value="" style={{ background: "#361519" }}>
                Select Inquiry Type
              </option>
              {INQUIRY_TYPES.map((t) => (
                <option key={t} value={t} style={{ background: "#361519" }}>
                  {t}
                </option>
              ))}
            </select>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            >
              ...
              {BUDGET_RANGES.map((b) => (
                <option key={b} value={b} style={{ background: "#361519" }}>
                  {b}
                </option>
              ))}
            </select>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label style={labelStyle}>
              First Name <span style={{ color: "#99561c" }}>*</span>
            </label>
            <input
              type="text"
              name="first_name"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            <label style={labelStyle}>
              Phone Number <span style={{ color: "#99561c" }}>*</span>
            </label>
            <input
              type="tel"
              name="phone"
